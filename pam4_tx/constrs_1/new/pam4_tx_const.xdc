...
#set_property DRIVE 8 [get_ports tx_lane0]
#set_property DRIVE 8 [get_ports tx_lane1]
#set_property SLEW SLOW [get_ports tx_lane0]
#set_property SLEW SLOW [get_ports tx_lane1]
